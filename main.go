...
func init() {
	...
	utilruntime.Must(ktunnelsv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a39e7441.int128.github.io",
	})
	if err != nil {
	...
	if err = (&controllers.AmazonAuroraClusterSetReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AmazonAuroraClusterSet")
		os.Exit(1)
	}
