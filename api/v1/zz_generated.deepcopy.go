...
func (in *ProxySpec) DeepCopyInto(out *ProxySpec) {
	*out = *in
	if in.TransitPortAllocation != nil {
		in, out := &in.TransitPortAllocation, &out.TransitPortAllocation
		*out = make([]*ProxyTransitPortAllocation, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ProxyTransitPortAllocation)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyTransitPortAllocation) DeepCopyInto(out *ProxyTransitPortAllocation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyTransitPortAllocation.
func (in *ProxyTransitPortAllocation) DeepCopy() *ProxyTransitPortAllocation {
	if in == nil {
		return nil
	}
	out := new(ProxyTransitPortAllocation)
