...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyTunnel) DeepCopyInto(out *ProxyTunnel) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyTunnel.
func (in *ProxyTunnel) DeepCopy() *ProxyTunnel {
	if in == nil {
		return nil
	}
	out := new(ProxyTunnel)
